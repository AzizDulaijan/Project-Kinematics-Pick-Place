...
from sympy import symbols, cos, sin, pi, simplify, atan2, sqrt, Matrix
...
def handle_calculate_IK(req):
	...
	#
	    ...
	    #calculate the wrist center position using end effector position and correct orientation.
